	...
	:mGraphics(graphics)
{
	...
	mVertexBuffer = mGraphics.CreateGraphicsBuffer( verts, vertCount * vertSize, EBF_VertexBuffer, ECPUAF_Neither, EGBU_Immutable );
	mIndexBuffer = mGraphics.CreateGraphicsBuffer( indices, indexCount * indexSize, EBF_IndexBuffer, ECPUAF_Neither, EGBU_Immutable );
}
